...
export function FilterBar() {
  const { categories, reviewStatuses, showDescoped, toggleCategory, toggleReviewStatus, setShowDescoped, clearAll } = useFilterStore()

  const hasActive = categories.length > 0 || reviewStatuses.length > 0
